...
- **[implement](./skills/engineering/implement/SKILL.md)** — Implement a PRD or set of issues: TDD at agreed seams, typecheck and test as you go, then review and commit.
